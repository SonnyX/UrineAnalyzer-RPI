AnalysisClass = class AnalysisClass {
  ...
  insert({data,counter}){
    ...
    let newPerHour = new SamplesPerHour( {_id,firstDate,frequency,counter} )
    if(data) {
      newPerHour.addSample(this,{data,counter})
      //if(isSampleBoolean) newPerHour.addSample(this,{data,counter})
      //else newPerHour.addCalibration(this,{data,counter})
    }
  ...
  update({data,counter}){
    ...
    for (var property in data) {
      if (filler.hasOwnProperty(property)) {
